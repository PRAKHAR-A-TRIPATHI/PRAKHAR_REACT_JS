...
export default function AddREcodeForm({ showRecordModal, handleCloseRecordModal, apiData,showConfirmationHandler,addMedicineFun }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (medicineCheak()) {
            addMedicineFun(formData,'http://localhost:3001/AddMedicineRecode')
                ...
                <Modal.Body>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className=' d-flex justify-content-between pt-2'>
                            ...
                            <Button variant="secondary" className=' btn btn-warning' onClick={handleCloseRecordModal}>
                                Close
                            </Button>
                        </div>
                    </form>
