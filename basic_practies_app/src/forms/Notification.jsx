...
export default function Notification({ show, confirmDelete, setIsDeleteConfirmationOpen, rowDataToDelete }) {
  return (
    <div className={`max-w-md mx-auto w-full  bg-white absolute left-1/3 top-20 p-6 rounded-md shadow-md  ${show ? 'block' : 'hidden'}`}>
      ...
      <h2 className="text-2xl font-semibold mb-6">Are You Soure Delete {rowDataToDelete} Row</h2>
